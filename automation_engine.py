...
class AutomationEngine:
    ...
    def process_patient(self, record):
        ...
        time.sleep(0.8)  # let the RDP session actually start receiving input -
                          # diagnose.py had this delay implicitly (screenshot
                          # overhead); the tool didn't, which may be why F3
                          # never visibly reached Nephro despite confirmed OS focus.
